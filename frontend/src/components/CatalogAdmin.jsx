...
export default function CatalogAdmin() {
  ...
  async function submit(e, path) {
    ...
    try {
      ...
      element.reset();
      setMessage("Definiție adăugată. Este disponibilă în Alimentație.");
    } catch (err) {
  ...
  return (
    <section className="panel">
      ...
      <p>
        ...
        fibre sau endurance. Unitățile existente nu se schimbă retroactiv.
      </p>
      <form onSubmit={(e) => submit(e, "/nutrients")}>
        <h3>Nutrient nou (opțional)</h3>
        <label>
          Cheie
          <input name="key" pattern="[a-z][a-z0-9_]{0,59}" required />
        </label>
        <label>
          Nume
